...
void ui_vladder_do(bContext *C, uiBut *but, void *vldata)
{
	uiVLadderData *data;
	int retval;
	...
	vldata = data;
//	retval = ui_vladder_handle(C, but, event, data);

}

int ui_vladder_handle(bContext *C, uiBut *but, const wmEvent *event, uiVLadderData *data)
{
